...
def construct_mip_for_assignment(
        bid_profile,
        bid_weights,
    ...
    return reviewers_vars, reviewers_used_vars, submissions_vars, m
...
def find_feasible_assignment(
    ...
    reviewers_vars, reviewers_used_vars, submissions_vars, m = construct_mip_for_assignment(
        bid_profile,
        bid_weights,
        max_num_reviews_asked,
        num_reviews_per_paper,
